# piping-server
[![CI](https://github.com/nwtgck/piping-server-rust/actions/workflows/ci.yml/badge.svg)](https://github.com/nwtgck/piping-server-rust/actions/workflows/ci.yml) [![Docker Image Size (latest by date)](https://img.shields.io/docker/image-size/nwtgck/piping-server-rust)](https://hub.docker.com/r/nwtgck/piping-server-rust)
