...
pub fn req_res_handler<F, Fut>(mut handler: F) -> impl (FnMut(Request<Body>) -> futures::future::Then< Fut, oneshot::Receiver<Response<Body>>, HoldOneReturnThatClosure<oneshot::Receiver<Response<Body>>> > ) where
